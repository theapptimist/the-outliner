...
export const LinkDocumentDialog = forwardRef<HTMLDivElement, LinkDocumentDialogProps>(
  function LinkDocumentDialog({ open, onOpenChange, onSelect, currentDocId }, ref) {
