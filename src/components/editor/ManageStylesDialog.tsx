...
interface ManageStylesDialogProps {
  open: boolean;
...
export function ManageStylesDialog({ 
  open, 
  onOpenChange, 
  onSelectStyle,
}: ManageStylesDialogProps) {
  ...
  const handleDuplicatePreset = (preset: typeof PRESET_STYLES[0]) => {
    setIsCreating(true);
    setEditingStyle(null);
    setStyleName(`${preset.name} (Copy)`);
    setStyleDescription(preset.description);
    setEditConfig({ ...preset.config } as ExtendedMixedStyleConfig);
  };

  const handleDuplicateCustom = (style: CustomStyle) => {
    setIsCreating(true);
    setEditingStyle(null);
          ...
          {!isEditorOpen ? (
              ...
              <ScrollArea className="h-[400px] pr-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground px-1 mb-2">
                    Presets cannot be edited. Duplicate to create your own version.
                  </p>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1">
                        <Button
                          ...
                          title="Duplicate as custom style"
                        >
                          <Copy size={14} />
                        </Button>
                        {onSelectStyle && (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <Button
                              ...
                              size="sm"
                              className="h-8 w-8 p-0"
                              onClick={() => handleDuplicateCustom(style)}
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-2 pt-2 border-t border-border">
                ...
                <Button onClick={handleSave} disabled={!styleName.trim()} className="gap-1">
                  <Check size={14} />
