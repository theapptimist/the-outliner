    ...
    <>
      ...
      <div className={cn("flex gap-1 flex-wrap", collapsed && "flex-col items-center")}>
        <ToolButton
          ...
          disabled={!editor}
          icon={<AlignLeft className="h-4 w-4 text-gray-700 dark:text-gray-300" />}
          label="Left"
          tooltip="Align Left"
          collapsed={true}
          color="blue"
        ...
        <ToolButton
          ...
          disabled={!editor}
          icon={<AlignCenter className="h-4 w-4 text-gray-700 dark:text-gray-300" />}
          label="Center"
        ...
        <ToolButton
          ...
          disabled={!editor}
          icon={<AlignRight className="h-4 w-4 text-gray-700 dark:text-gray-300" />}
          label="Right"
          tooltip="Align Right"
          collapsed={true}
          color="blue"
        ...
        <ToolButton
          ...
          disabled={!editor}
          icon={<AlignJustify className="h-4 w-4 text-gray-700 dark:text-gray-300" />}
          label="Justify"
          tooltip="Justify"
          collapsed={true}
          color="blue"
      ...
      <div className={cn("flex gap-1 flex-wrap", collapsed && "flex-col items-center")}>
        <ToolButton
          ...
          disabled={!editor}
          icon={<Heading1 className="h-4 w-4 text-gray-700 dark:text-gray-300" />}
          label="H1"
          tooltip="Heading 1"
          collapsed={true}
          color="purple"
        ...
        <ToolButton
          ...
          disabled={!editor}
          icon={<Heading2 className="h-4 w-4 text-gray-700 dark:text-gray-300" />}
          label="H2"
          tooltip="Heading 2"
          collapsed={true}
          color="purple"
        ...
        <ToolButton
          ...
          disabled={!editor}
          icon={<Heading3 className="h-4 w-4 text-gray-700 dark:text-gray-300" />}
          label="H3"
          tooltip="Heading 3"
          collapsed={true}
          color="purple"
      ...
      <div className={cn("grid grid-cols-2 gap-1", collapsed && "grid-cols-1")}>
        <ToolButton
          ...
          disabled={!editor}
          icon={<List className="h-4 w-4 text-gray-700 dark:text-gray-300" />}
          label="Bullets"
          tooltip="Bullet List"
          collapsed={true}
          color="green"
        ...
        <ToolButton
          ...
          disabled={!editor}
          icon={<ListOrdered className="h-4 w-4 text-gray-700 dark:text-gray-300" />}
          label="Numbers"
        ...
        <ToolButton
          ...
          disabled={!editor}
          icon={<Quote className="h-4 w-4 text-gray-700 dark:text-gray-300" />}
          label="Quote"
          tooltip="Block Quote"
          collapsed={true}
          color="green"
        ...
        <ToolButton
          ...
          disabled={!editor}
          icon={<Minus className="h-4 w-4 text-gray-700 dark:text-gray-300" />}
          label="Divider"
